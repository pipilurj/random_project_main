from debug.prepare_mask.refer import REFER
import numpy as np
...
import pickle
from debug.prepare_mask.poly_utils import is_clockwise, revert_direction, check_length, reorder_points, \
...
image_dir = '/home/pirenjie/data/refcoco/images/train2014'
val_test_files = pickle.load(open("debug/val_test_files.p", "rb"))
...
for dataset in datasets:
    ...
    save_dir = f'debug/poly_masks/{dataset}'
...
file_name = os.path.join("debug/refcoco+g_train_shuffled.tsv")
print("creating ", file_name)
writer = open(file_name, 'w')
