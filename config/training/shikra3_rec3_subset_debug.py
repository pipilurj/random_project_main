_base_ = ['../_base_/dataset/DEFAULT_TEST_REC_VARIANT.py','../_base_/dataset/mix_pretrain_concat3.py', '../_base_/model/shikra.py', '../_base_/train/shikra_deepspeed_lora.py']
...
data_args = dict(
    ...
    train=dict(
        ...
        type='ConcatDataset',
        cfgs=[
            {{_base_.DEFAULT_TEST_REC_VARIANT.REC_REFCOCOG_UMD_TEST_subset}}
