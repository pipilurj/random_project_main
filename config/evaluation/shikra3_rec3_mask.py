_base_ = ['../_base_/dataset/DEFAULT_TEST_RES_VARIANT.py', '../_base_/model/shikra.py', '../_base_/train/eval.py']
...
data_args = dict(
    ...
    validation=_base_.DEFAULT_TEST_RES_VARIANT.RES_REFCOCOG_UMD_VAL,
    # validation=_base_.DEFAULT_TEST_REC_VARIANT.REC_REFCOCOG_UMD_TEST_subset,
    test=None,
    multitest=None,

    compute_metric=dict(type='RECMaskComputeMetrics'),
