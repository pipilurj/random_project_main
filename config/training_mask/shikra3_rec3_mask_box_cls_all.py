...
data_args = dict(
    ...
    validation=dict(
        ...
        cfgs=[
            # {{_base_.DEFAULT_TRAIN_DATASET.rec}},
            {{_base_.DEFAULT_TEST_REC_VARIANT.REC_REFCOCO_UNC_VAL}},
            {{_base_.DEFAULT_TEST_REC_VARIANT.REC_REFCOCOA_UNC_VAL}},
            {{_base_.DEFAULT_TEST_REC_VARIANT.REC_REFCOCOG_UMD_VAL}}
            # {{_base_.DEFAULT_TRAIN_DATASET.recvg}},
        ],
    ),
    test=None,
